...
public class LoginActivity extends AppCompatActivity implements SplashFragment.OnFragmentInteractionListener {
...
//        apiCallService.searchForSong("Million Reasons Lady Gaga");
        fragmentService.loadFragment(SplashFragment.newInstance(), Constants.LOGIN_CONTAINER);
    }
